                        ...
                        <div class="panel panel-default rightpanel-box">
                            <div class="panel-body rightpanel-box1">
                                <h4 class="coming-soon-back-text">
                                    <a href="<?= base_url(); ?>noticeboard/event_schedule" class="back-btn"><i class="fa fa-arrow-left" aria-hidden="true"></i> 
                                    Back</a>
                                </h4>
                                                ...
                                                if(file_exists($url)){
                                                    $locationUrl = $detail['location'];                                             
                                                        if($detail['DOWNLOADABLE'] == 'YES'){?>
                                                            ...
                                                            <div id="pdfviewerDiv" style="width:100%; padding-top:15px;">
