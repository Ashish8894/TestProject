                ...
                <div class="panel panel-default rightpanel-box">
                    <div class="panel-body rightpanel-box1" >
                        <h4 class="coming-soon-back-text">
                            <a href="<?= site_url(); ?>practice/msteps/<?php echo $topicid; ?>/<?php echo $level; ?>" class="back-btn">
   ...
   <?= $this->include('components/footer.php'); ?>  
         <script type="text/javascript">
            ...
            $(document).ready(function(){  
                ...
                let oObj = JSON.parse(subQueObject);
                ...
                for(let i = 0;i < y;i++){
                    if(tid == tObj[i].TOPIC_ID){
                        testlist = tObj[i].TOPIC_NAME+'<br/><small class="study-plan-name-questions">Lecture '+level+' - Step '+step+'</small>';
                        title = tObj[i].TOPIC_NAME+' | Lecture '+level+' - Step '+step;
                    }
                ...
                function getquestions(){
                    ...
                    $.ajax({ 
                        ...
                        dataType: 'json', 
                        url: "<?= site_url(); ?>practice/subjective_steps_questions",
