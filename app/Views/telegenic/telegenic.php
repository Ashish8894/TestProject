                    ...
                    <div class="col-md-12 col-lg-10 col-xl-10 col-xxl-8 col-sm-12 col-12 mx-auto common-mb "><!--pratice-box attendace-list-box-->
                        <div class="row">
                            <div class="coming-soon-block text-center">
                                <img src="<?= base_url()?>assets/images/cs.svg" class="img-coming-soon">
                                <div class="">
                                    <p class="coming-soon-block-text">Coming Soon</p>
  ...
  <?php echo $this->include('components/footer.php'); ?>
    <script type="text/javascript">
        $(document).ready(function(){
            $('#pgtelegenic').addClass('active');
            $('#mobTelegenic').addClass('active');
        })
    </script>
